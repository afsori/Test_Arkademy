...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <h2></h2>
            <!-- <a href="<?php echo base_url() ?>templates/dist/img/afs.jpg"> -->
            <!-- <b>Silahkan</b>Login -->
            </a>
            <!-- <img src="<?php echo base_url(); ?>templates/dist/img/avatar.png" width="90%" style=" object-fit: cover;"> -->
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            <div class="social-auth-links text-center">
                ...
                <a href="<?= base_url('auth/registrasi'); ?>" class="text-center">Buat Akun Baru !</a>
            </div>
            <!-- /.social-auth-links -->
